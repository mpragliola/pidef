...
async function capturePdfStates(): Promise<void> {
  ...
  await page.dispatchEvent('#btn-toggle-bookmarks-nav', 'pointerdown', { button: 0, buttons: 1 });
  await page.waitForTimeout(600);
  await page.dispatchEvent('#btn-toggle-bookmarks-nav', 'pointerup', { button: 0, buttons: 0 });
